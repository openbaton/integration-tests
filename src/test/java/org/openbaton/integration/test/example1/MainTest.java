...
public class MainTest {
  ...
  public static void main(String[] args) {
    ...
    IntegrationTestManager itm =
        new IntegrationTestManager("org.openbaton.integration.test.example1.Tasks") {
          @Override
          protected void configureSubTask(SubTask subTask, Profile.Section currentSection) {
            if (subTask instanceof Task3) {
              ...
              t3.setSpecificParameter(
                  Double.parseDouble(currentSection.get("specific-parameter", "5")));
            }
          }
        };
    ...
    else System.out.println("Test: " + file.getName() + " completed with errors :(");
  }
}
